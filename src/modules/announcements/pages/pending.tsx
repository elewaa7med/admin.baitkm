...
@byPrivateRoute(ROUTES.ANNOUNCEMENTS_PENDING)
class Pending extends React.Component<{}, {}> {
    public state: IState = {
        ...
        form: {
            ...
            landType: null,
            commercialType: null,
            announcementStatus: AnnouncementStatusEnum.Pending,
            features: [],
            priceFrom: 0,
            priceTo: 0,
            minArea: 0,
    ...
    public changeFilters = async (form: IAddSaveFilterRequestModel) => {
        ...
        window.routerHistory.replace(query ? `${ROUTES.ANNOUNCEMENTS_PENDING}?${query}` : ROUTES.ANNOUNCEMENTS_PENDING);
        this.setState({ form });
    ...
    private columnConfig = [
        {
            ...
            style: { minWidth: 370 },
            cell: (row: any) =>
                <Link to={ROUTES.ANNOUNCEMENT_DETAILS.replace(':id', row.id.toString())}>
                    ...
                    <div className='B-announcement-list'>
                        {(data.data && data.data.length !== 0) ?
                            ...
                            : <div className='B-data-empty'>
                                ...
                                <p>Pending announcement list is empty</p>
                            </div>}
                    </div>
