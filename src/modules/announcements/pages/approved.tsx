...
interface IState {
    ...
    data: IPagingRes<IUserApproved> | null,
...
@byPrivateRoute(ROUTES.ANNOUNCEMENTS)
class Approved extends React.Component<{}, {}> {
    ...
    private columnConfig = [
        {
            ...
            style: { minWidth: 370 },
            cell: (row: any) =>
            <Link to={ ROUTES.ANNOUNCEMENT_DETAILS_APPROVED.replace(':id', row.id.toString())}>
    ...
    public changeFilters = async (form: IAddSaveFilterRequestModel) => {
        ...
        window.routerHistory.replace(query ? `${ROUTES.ANNOUNCEMENTS}?${query}` : ROUTES.ANNOUNCEMENTS);
        this.setState({form});
                    ...
                    <div className='B-announcement-list'>
                        {(data.data && data.data.length!==0)?
                            ...
                            :   <div className='B-data-empty'>
                                ...
                                <p>Approved announcement list is empty</p>
                            </div>}
                    </div>
